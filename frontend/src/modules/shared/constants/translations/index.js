export const translations = {
  en: {
    ...
    login: {
      ...
      subtitle: "Existing patients can look up their record, and new patients can register in a few steps.",
      sectionLabel: "Patient portal",
      existingTitle: "Existing patient",
      existingDescription: "Enter your mobile number to find your record and continue your visit.",
      newTitle: "New patient",
      newDescription: "Start a new registration if you are visiting for the first time.",
      mobileLabel: "Mobile Number",
      mobileHint: "Use the 10-digit number linked to your record.",
      continueButton: "Continue",
      registerButton: "Register new patient",
      checking: "Checking...",
      or: "or",
      doctorLogin: "Login as Doctor",
      doctorPrompt: "Doctor access is available from the clinical portal.",
      patientFound: "Patient record found!",
      notFound: "No record found for this number.",
      switchToRegister: "Switch to registration",
      feature1: "Fast check-in",
      feature2: "Secure patient lookup",
      feature3: "Simple registration"
    },
